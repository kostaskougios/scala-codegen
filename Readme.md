...
compile we can make sense of it, we can create code 
outside the compilation unit (i.e. multiple classes/objects and packages from 1 src class), we get full
...
we can generate code not only from scala declarations but i.e. from a database, csv or xml files. 
